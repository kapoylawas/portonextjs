const n = "md-editor", l = "md-editor-rt", d = "https://at.alicdn.com/t/c/font_2605852_u82y61ve02.js", e = "https://cdnjs.cloudflare.com/ajax/libs", c = `${e}/highlight.js/11.7.0/highlight.min.js`, h = {
...
}, m = `${e}/screenfull.js/5.2.0/screenfull.min.js`, a = [
  "bold",
  "underline",
  "italic",
  "strikeThrough",
  ...
  "catalog",
  "github"
], o = ["markdownTotal", "=", "scrollSwitch"], u = {
  "zh-CN": {
    toolbarTips: {
      bold: "加粗",
      underline: "下划线",
...
}, p = `${e}/mermaid/10.1.0/mermaid.esm.min.mjs`, k = {
